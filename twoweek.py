...
def fetch_and_send_menu():
    ...
    #Simulate "SEURAAVA VIIKKO" button click
    post_data = {
        '__VIEWSTATE': viewstate,
        '__VIEWSTATEGENERATOR': viewstate_generator,
        '__EVENTVALIDATION': event_validation,
        '__EVENTTARGET': 'ctl00$MainContent$RestaurantDateRangesFilterHeadersDataList$ctl02$RestaurantDateRangesFilterHeadersLinkButton',
        '__EVENTARGUMENT': ''
    }
